...
import doitincloud.oauth2.providers.PreAuthProvider;
import doitincloud.oauth2.providers.UserAuthProvider;
import doitincloud.oauth2.services.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public PreAuthProvider preAuthProvider() {
        return new PreAuthProvider(tokenStore, userRepo);
    }
